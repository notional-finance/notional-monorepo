...
import { NOTESummary, BalanceSummary, AssetSummary } from '@notional-finance/sdk-v2/account';
...
export interface ERC20 {
  ...
  approve: (address: string, amount: BigNumberish) => Promise<ContractTransaction>;
}
