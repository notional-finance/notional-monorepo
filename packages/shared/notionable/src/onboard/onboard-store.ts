...
export const onboardConnected$ = selectOnboardState('connected') as Observable<boolean>;

export const signer$ = selectOnboardState('signer') as Observable<providers.JsonRpcSigner | null>;
