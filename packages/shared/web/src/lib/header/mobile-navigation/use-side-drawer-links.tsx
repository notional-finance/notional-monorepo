...
import { GitHub, Twitter, YouTube, DescriptionOutlined } from '@mui/icons-material';
    ...
    learn: {
      ...
      data: [
        ...
        },
        {
          ...
          label: <FormattedMessage defaultMessage={'Developer Documentation'} />,
          link: 'https://docs.notional.finance/developer-documentation/',
          iconImg: (
            <DeveloperDocsIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />
          ),
        },
        {
          key: 'video_tutorials',
          ...
          iconImg: <YouTube sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
        },
      ],
    },
    governance: {
      ...
      data: [
        {
          ...
          link: '/governance',
          iconImg: (
            <GovernanceIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />
          ),
        },
        {
          ...
          iconImg: <TuneIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
        },
        {
          ...
          iconImg: <ForumIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
        },
      ],
    },
    community: {
      ...
      data: [
        {
          ...
          iconImg: (
            <DescriptionOutlined sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />
          ),
        },
        {
          key: 'discord',
          ...
          iconImg: (
            <DiscordPlainIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />
          ),
        },
        {
          key: 'github',
          ...
          iconImg: <GitHub sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
        },
        {
          key: 'twitter',
          label: <FormattedMessage defaultMessage={'Twitter'} />,
          link: 'https://twitter.com/NotionalFinance',
          iconImg: <Twitter sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
        },
        {
          key: 'youtube',
...
export const useSideDrawerLinks = (dataKey: string) => {
  const theme = useTheme();
  let result;
  if (dataKey === 'company') {
    result = [
      ...
      },
      {
        ...
        iconImg: <BlocksIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
      },
      {
        key: 'dashboard',
        ...
        noBottomBorder: true,
        iconImg: <DashboardIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
      },
    ];
  } else {
    result = [
      ...
      },
      {
        ...
        iconImg: <InsuranceIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
      },
      {
        key: 'bug_bounty',
        label: <FormattedMessage defaultMessage={'Bug Bounty'} />,
        link: 'https://immunefi.com/bounty/notional/',
        iconImg: <BugBountyIcon sx={{ color: theme.palette.common.black, fontSize: '1.125rem' }} />,
      },
      {
        key: 'protocol_parameters',
        label: <FormattedMessage defaultMessage={'Protocol Parameters'} />,
