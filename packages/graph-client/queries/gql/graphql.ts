...
export type CurrenciesQuery = { __typename?: 'Query', currencies: Array<{ __typename?: 'Currency', id: string, tokenAddress: string, tokenType: TokenType, decimals: string, name: string, symbol: string }> };
