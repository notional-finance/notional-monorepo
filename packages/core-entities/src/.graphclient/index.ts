...
> = ResolversObject<{
  ...
  _accumulatedCostRealized?: Resolver<
    ...
    ContextType
  >;
  _accumulatedCostAdjustedBasis?: Resolver<
    ResolversTypes['BigInt'],
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  ...
  primeCashHoldings?: Resolver<
    ...
    ContextType
  >;
  rebalancingTargets?: Resolver<
    Maybe<Array<ResolversTypes['Int']>>,
    ParentType,
    ContextType
  >;
  rebalancingCooldown?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType
  >;
  ...
  liquidationHaircutPercentage?: Resolver<
    ...
    ContextType
  >;
  maxMintDeviationPercentage?: Resolver<
    Maybe<ResolversTypes['Int']>,
    ParentType,
    ContextType
  >;
...
> = ResolversObject<{
  ...
  vault?: Resolver<
    ...
    ContextType
  >;
  rewardTokenSold?: Resolver<ResolversTypes['Bytes'], ParentType, ContextType>;
...
export async function getMeshOptions(): Promise<GetMeshOptions> {
  ...
  const notionalV3Handler = new GraphqlHandler({
    ...
    config: {
      endpoint:
        'https://api.studio.thegraph.com/query/36749/notional-finance-v3-arbitrum/v0.1.34',
    },
    baseDir,
    cache,
    pubsub,
...
export type AllConfigurationQuery = {
  ...
  >;
  whitelistedContracts: Array<Pick<WhitelistedContract, 'id' | 'capability'>>;
