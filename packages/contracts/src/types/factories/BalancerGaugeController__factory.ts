...
import type {
  ...
  BalancerGaugeControllerInterface,
} from "../BalancerGaugeController";
...
export class BalancerGaugeController__factory {
  ...
  static createInterface(): BalancerGaugeControllerInterface {
    return new utils.Interface(_abi) as BalancerGaugeControllerInterface;
  }
  static connect(
    address: string,
