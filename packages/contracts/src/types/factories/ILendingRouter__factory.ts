...
export class ILendingRouter__factory {
  static readonly abi = _abi;
  static createInterface(): ILendingRouterInterface {
    return new utils.Interface(_abi) as ILendingRouterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ILendingRouter {
    return new Contract(address, _abi, signerOrProvider) as ILendingRouter;
  }
}
