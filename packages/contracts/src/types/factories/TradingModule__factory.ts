...
import type { TradingModule, TradingModuleInterface } from "../TradingModule";
...
const _abi = [
  ...
  },
  {
    inputs: [
      {
        internalType: "uint32",
        name: "maxOracleFreshnessInSeconds_",
        type: "uint32",
      },
    ],
    name: "initialize",
...
export class TradingModule__factory {
  static readonly abi = _abi;
  static createInterface(): TradingModuleInterface {
    return new utils.Interface(_abi) as TradingModuleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): TradingModule {
    return new Contract(address, _abi, signerOrProvider) as TradingModule;
  }
}
