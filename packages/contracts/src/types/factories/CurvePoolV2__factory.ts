...
import type { CurvePoolV2, CurvePoolV2Interface } from "../CurvePoolV2";
...
export class CurvePoolV2__factory {
  ...
  static createInterface(): CurvePoolV2Interface {
    return new utils.Interface(_abi) as CurvePoolV2Interface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): CurvePoolV2 {
    return new Contract(address, _abi, signerOrProvider) as CurvePoolV2;
  }
}
