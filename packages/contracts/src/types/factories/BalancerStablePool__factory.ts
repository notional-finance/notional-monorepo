...
import type {
  BalancerStablePool,
  BalancerStablePoolInterface,
} from "../BalancerStablePool";
...
export class BalancerStablePool__factory {
  static readonly abi = _abi;
  static createInterface(): BalancerStablePoolInterface {
    return new utils.Interface(_abi) as BalancerStablePoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BalancerStablePool {
    return new Contract(address, _abi, signerOrProvider) as BalancerStablePool;
  }
}
