...
export interface NTokenERC20Interface extends utils.Interface {
  functions: {
    ...
    "getPresentValueAssetDenominated()": FunctionFragment;
    "getPresentValueUnderlyingDenominated()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getPresentValueAssetDenominated",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "getPresentValueUnderlyingDenominated",
    values?: undefined
  ): string;
...
export interface NTokenERC20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NTokenERC20Interface;
