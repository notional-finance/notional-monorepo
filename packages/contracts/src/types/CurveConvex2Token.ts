...
export type DeploymentParamsStruct = {
  ...
  convexRewardPool: PromiseOrValue<string>;
  curveInterface: PromiseOrValue<BigNumberish>;
};
...
export type DeploymentParamsStructOutput = [
  ...
  curveInterface: number;
};

export interface CurveConvex2TokenInterface extends utils.Interface {
  functions: {
    "CURVE_POOL_TOKEN()": FunctionFragment;
    "MAX_POOL_SHARE()": FunctionFragment;
    "PRIMARY_INDEX()": FunctionFragment;
    "REWARD_MANAGER()": FunctionFragment;
    ...
    "claimAccountRewards(address,uint256)": FunctionFragment;
    ...
    "getInternalStorage()": FunctionFragment;
    "initialize(bytes)": FunctionFragment;
    "initiateWithdraw(address,uint256,bytes,address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "CURVE_POOL_TOKEN",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "MAX_POOL_SHARE",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "PRIMARY_INDEX",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "REWARD_MANAGER",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "getInternalStorage",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CurveConvex2Token extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveConvex2TokenInterface;
  ...
  functions: {
    CURVE_POOL_TOKEN(overrides?: CallOverrides): Promise<[string]>;

    MAX_POOL_SHARE(overrides?: CallOverrides): Promise<[BigNumber]>;

    PRIMARY_INDEX(overrides?: CallOverrides): Promise<[BigNumber]>;

    REWARD_MANAGER(overrides?: CallOverrides): Promise<[string]>;
    ...
    getInternalStorage(
      ...
      [BigNumber, BigNumber, BigNumber, BigNumber] & {
        ...
        escrowedShares: BigNumber;
        accruedFeesInYieldToken: BigNumber;
        lastFeeAccrualTime: BigNumber;
      }
    >;
  ...
  filters: {
    ...
    "FeesCollected(uint256)"(feesCollected?: null): FeesCollectedEventFilter;
    FeesCollected(feesCollected?: null): FeesCollectedEventFilter;
  ...
  estimateGas: {
    CURVE_POOL_TOKEN(overrides?: CallOverrides): Promise<BigNumber>;

    MAX_POOL_SHARE(overrides?: CallOverrides): Promise<BigNumber>;

    PRIMARY_INDEX(overrides?: CallOverrides): Promise<BigNumber>;

    REWARD_MANAGER(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    getInternalStorage(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    CURVE_POOL_TOKEN(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    MAX_POOL_SHARE(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    PRIMARY_INDEX(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    REWARD_MANAGER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
