...
export interface BalancerLinearPoolInterface extends utils.Interface {
  functions: {
...
export type TargetsSetEvent = TypedEvent<
...
export interface BalancerLinearPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerLinearPoolInterface;
