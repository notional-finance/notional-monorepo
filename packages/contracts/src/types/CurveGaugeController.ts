...
export interface CurveGaugeControllerInterface extends utils.Interface {
  functions: {
...
export interface CurveGaugeController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurveGaugeControllerInterface;
