...
export interface AuraRewardPoolInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "processIdleRewards",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface AuraRewardPool extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AuraRewardPoolInterface;
