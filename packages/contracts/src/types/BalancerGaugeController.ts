...
export interface BalancerGaugeControllerInterface extends utils.Interface {
  functions: {
...
export interface BalancerGaugeController extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BalancerGaugeControllerInterface;
  ...
  functions: {
    ...
    vote_for_many_gauge_weights(
      _gauge_addrs: PromiseOrValue<string>[],
