...
export type ThreeTokenPoolContextStruct = {
  tertiaryToken: PromiseOrValue<string>;
  tertiaryIndex: PromiseOrValue<BigNumberish>;
  tertiaryDecimals: PromiseOrValue<BigNumberish>;
  tertiaryBalance: PromiseOrValue<BigNumberish>;
  basePool: TwoTokenPoolContextStruct;
};

export type ThreeTokenPoolContextStructOutput = [
  string,
  number,
  number,
  BigNumber,
  ...
  tertiaryDecimals: number;
  tertiaryBalance: BigNumber;
...
export type Boosted3TokenAuraStrategyContextStruct = {
  poolContext: ThreeTokenPoolContextStruct;
  oracleContext: BoostedOracleContextStruct;
  stakingContext: AuraStakingContextStruct;
  baseStrategy: StrategyContextStruct;
};

export type Boosted3TokenAuraStrategyContextStructOutput = [
  ThreeTokenPoolContextStructOutput,
  BoostedOracleContextStructOutput,
  AuraStakingContextStructOutput,
  StrategyContextStructOutput
] & {
  poolContext: ThreeTokenPoolContextStructOutput;
  oracleContext: BoostedOracleContextStructOutput;
