...
export interface CurvePoolV1WithOracleInterface extends utils.Interface {
  functions: {
    "A()": FunctionFragment;
...
export interface CurvePoolV1WithOracle extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CurvePoolV1WithOracleInterface;
