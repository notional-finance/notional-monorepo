...
interface BorrowMigrationProps {
  safeAddress: string;
}

export const BorrowMigration = ({ safeAddress }: BorrowMigrationProps) => {
  ...
  return (
    <Container>
      <Box>
        ...
        <Body sx={{ fontSize: theme.spacing(2), marginTop: theme.spacing(3) }}>
          <FormattedMessage
            defaultMessage={
...
export default BorrowMigration;
