...
import { usePortfolioSNOTETable } from '@notional-finance/portfolio-feature-shell/hooks';
    ...
    <>
      <Container>
        ...
        <ContentContainer>
          ...
          <Row>
            <Label>
              <FormattedMessage id="noteValue" defaultMessage="Note Value" />
            </Label>
            <Column>
              <Value>{value.noteValue.data?.[0]?.displayValue}</Value>
              <Caption>{value.noteValue.data?.[1]?.displayValue}</Caption>
            </Column>
          </Row>

          <Row>
            <Label>
              <FormattedMessage id="totalValue" defaultMessage="Total Value" />
            </Label>
            <Column>
