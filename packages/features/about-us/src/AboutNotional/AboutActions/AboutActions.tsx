...
import aboutPageBuild from 'assets/icons/marketing/about-page-build.svg';
import aboutPageDiscuss from 'assets/icons/marketing/about-page-discuss.svg';
import aboutPageVote from 'assets/icons/marketing/about-page-vote.svg';
import { Box, useTheme } from '@mui/material';
import { BlocksIcon, DiscordIcon, GovernanceIcon } from '@notional-finance/icons';
...
const aboutActions = [
  ...
  },
  {
    ...defineMessages({
      ...
      description: {
        description: 'description',
        defaultMessage: 'Vote on risk parameter settings and community-led proposals.',
      },
      callToAction: {
        description: 'call to action',
...
export const AboutActions = () => {
  ...
  return (
    ...
    >
      {aboutActions.map(({ ctaIcon, title, description, callToAction, image, href }, i) => {
        ...
        const actionText = (
          ...
          >
            ...
            <H3 fontWeight="regular" lineHeight={2} marginBottom={theme.spacing(6)}>
            ...
            >
              {ctaIcon({ sx: { color: theme.palette.common.white, marginRight: '.5rem' } })}
        ...
        const actionImageDesktop = (
          <Box sx={{ display: { xs: 'none', lg: 'block' } }}>{actionImage}</Box>
        );
        const actionImageMobile = (
          <Box sx={{ display: { xs: 'block', lg: 'none' } }}>{actionImage}</Box>
        );
        return (
          <Box
            sx={{
