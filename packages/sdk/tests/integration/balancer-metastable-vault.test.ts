...
import poolABI from '../../src/abi/BalancerStablePool.json';
...
describe('balancer vault test', () => {
  ...
  beforeEach(async () => {
    ...
    const swapFeePercentage = FixedPoint.from(
      await balancerPool.getSwapFeePercentage()
    );
