  ...
  return (
    <FeatureLoader>
      <AirdropContainer>
        <H1>Claim Your NOTE Airdrop</H1>
        <p>
          Enter an Ethereum address to claim your NOTE airdrop. Any Ethereum
          wallet can submit the claim, but the NOTE tokens will be only be
          transferred to the address entered. See the&nbsp;
          <a
            target="_blank"
            rel="noreferrer"
          ...
          &nbsp;A second airdrop for LPs is also available through this site (if
          you are eligible for both you must have claimed the first airdrop).
          The list for the&nbsp;
          <a
            target="_blank"
            rel="noreferrer"
        ...
        >
          <TextField
            ...
            onChange={(event) =>
              updateAirdropState({ address: event.target.value })
            }
            value={address}
            sx={{
