...
const faqs = [
  ...
  defineMessages({
    question: {
      defaultMessage: "What's the difference between fixed rates on Notional and 'stable rates' found elsewhere?",
      description: 'faq question'
    },
    answer: {
      defaultMessage:
      ...
      >
        <Box padding={{ xs: theme.spacing(8, 4), lg: theme.spacing(12, 18) }}>
          <Box marginBottom={theme.spacing(6)}>
            <H1 marginBottom={theme.spacing(6)} sx={{ textAlign: { xs: 'center', lg: 'left' } }}>
              <FormattedMessage
          ...
          <Box display="flex" justifyContent="center">
            ...
            >
              <FormattedMessage defaultMessage="More FAQs" description="button link text" />
            </Button>
          </Box>
        </Box>
      </Box>
